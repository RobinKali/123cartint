...
export const fallbackPortfolioItems: PortfolioItem[] = [
  ...
  { id: '4', title: 'Hoogglans Zwart De-chrome', category: 'Dechrome', categoryLabel: 'Ontchromen', brand: '', imageUrl: '/de-chrome-hero.jpg', altText: 'Auto de-chrome hoogglans zwart' },
